...
{
    internal static class PlayerReputationGeneration
    {
        ...
        {
            return new XElement("replace", new XAttribute("sel", "/mdscript/cues/cue[@name='TrackPlayerReputation']/conditions/check_value/@value"),
