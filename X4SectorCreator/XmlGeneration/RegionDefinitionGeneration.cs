                ...
                foreach (var sector in cluster.Sectors)
                {
                    foreach (var region in sector.Regions)
                    {
                        ...
                        yield return new XElement("region",
                            ...
                            new XAttribute("seed", region.Seed),
                            new XAttribute("minnoisevalue", region.MinNoiseValue),
                            new XAttribute("maxnoisevalue", region.MaxNoiseValue),
                            new XElement("boundary",
                                new XAttribute("class", $"{region.BoundaryType}"),
                                new XElement("size",
