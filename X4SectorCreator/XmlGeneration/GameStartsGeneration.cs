            ...
            var gameStartElement = new XElement("gamestart",
                ...
                new XElement("player",
                    ...
                    new XElement("blueprints",
                        new XElement("ware", new XAttribute("ware", "clothingmod_0001")),
                        new XElement("ware", new XAttribute("ware", "clothingmod_0002")),
                        new XElement("ware", new XAttribute("ware", "module_arg_dock_m_01_lowtech")),
                        new XElement("ware", new XAttribute("ware", "module_par_pier_l_01")),
                        new XElement("ware", new XAttribute("ware", "module_par_stor_container_s_01")),
                        new XElement("ware", new XAttribute("ware", "module_par_conn_base_01")),
                        new XElement("ware", new XAttribute("ware", "module_par_conn_cross_01")),
                        new XElement("ware", new XAttribute("ware", "module_par_conn_vertical_01")),
                        new XElement("ware", new XAttribute("ware", "module_gen_prod_energycells_01")),
                        new XElement("ware", new XAttribute("ware", "module_par_prod_sojabeans_01")),
                        new XElement("ware", new XAttribute("ware", "paintmod_0006")),
                        new XElement("ware", new XAttribute("ware", "paintmod_0048")),
                        new XElement("ware", new XAttribute("ware", "paintmod_0049")),
                        new XElement("ware", new XAttribute("ware", "paintmod_0050"))
                    ),
