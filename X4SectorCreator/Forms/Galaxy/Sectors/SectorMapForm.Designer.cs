namespace X4SectorCreator
{
    partial class SectorMapForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            MapOptionsListBox.Items.AddRange(new object[] { "Show Vanilla Sectors", "Show Custom Sectors", "Show Connections", "Show Coordinates", "Show Vanilla Regions", "Show Custom Regions", "Visualize Regions", "Show Stations" });
