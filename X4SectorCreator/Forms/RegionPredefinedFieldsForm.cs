...
namespace X4SectorCreator.Forms
{
    public partial class RegionPredefinedFieldsForm : Form
    {
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                _ = MainForm.Instance.RegionForm.Value.RegionDefinitionForm.ListBoxFields.Items.Add(item);
            }

            if (selectedFieldObjects.Length == 1)
            {
                MainForm.Instance.RegionForm.Value.RegionDefinitionForm.ListBoxFields.SelectedItem = selectedFieldObjects[0];
            }
